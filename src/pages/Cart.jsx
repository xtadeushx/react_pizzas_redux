          ...
          <div className="cart__bottom">
            <div className="cart__bottom-details">
              ...
              <span>
                ...
                <b>
                  {totalBill} {isUkraine ? CURRENT__CURRENCY.ua : CURRENT__CURRENCY.ru}
                </b>{' '}
              </span>
            </div>
            <div className="cart__bottom-buttons">
              <Link to="/" className="button button--outline button--add go-back-btn">
                ...
                <span>{isUkraine ? 'Повернутись назад' : 'Вернуться назад'}</span>
              </Link>
              <div className="button pay-btn">
                <span>{isUkraine ? 'Оплатити зараз' : 'Оплатить сейчас'}</span>
              </div>
            </div>
          </div>
        </div>
